...
class StockPredictor:
    ...
    def _initialize_sentiment_analyzer(self):
        ...
        try:
            ...
            logger.info(f"Initialized sentiment analyzer with method: {self.sentiment_method}")
    ...
    def _fetch_and_analyze_sentiment(self) -> pd.DataFrame:
        ...
        try:
            ...
            sentiment_summary = {
                ...
                'avg_sentiment_compound': sentiment_df['compound'].mean() if 'compound' in sentiment_df else 0.0,
                'avg_sentiment_pos': sentiment_df['pos'].mean() if 'pos' in sentiment_df else 0.0,
                'avg_sentiment_neg': sentiment_df['neg'].mean() if 'neg' in sentiment_df else 0.0,
                'avg_sentiment_neu': sentiment_df['neu'].mean() if 'neu' in sentiment_df else 0.0,
            }
            ...
            logger.info(f"Sentiment analysis complete: {sentiment_summary['overall_sentiment']} "
        ...
        if self.enable_sentiment:
            try:
                ...
                if not sentiment_features.empty:
                    ...
                    logger.info(f"Added sentiment features to data: {list(sentiment_features.columns)}")
    ...
    def get_technical_indicators(self) -> pd.DataFrame:
        ...
        indicators = ['sma_20', 'sma_50', 'rsi_14', 'macd', 'macd_signal', 
